        ...
        private void ReceiveCallback(IAsyncResult ar)
        {
            try
            {
                ...
                if (Encoding.ASCII.GetString(dataBuffer).Equals("RQ:T"))
                {
                    ...
                    //id, name, left, right, bottom, top
                    tafels.Add("1|TAFEL 1|3|3|0|0");
                    tafels.Add("2|TAFEL 2|15|350|0|0");
                    tafels.Add("3|TAFEL 3|35|200|0|0");
                    tafels.Add("4|TAFEL 4|561|218|0|0");
                    tafels.Add("5|TAFEL 5|361|218|0|0");
                    tafels.Add("6|TAFEL 6|161|218|0|0");
                    tafels.Add("1|TAFEL 1|3|3|0|0");
                    tafels.Add("2|TAFEL 2|15|350|0|0");
                    tafels.Add("3|TAFEL 3|35|200|0|0");
                    tafels.Add("4|TAFEL 4|561|218|0|0");
            ...
            catch (SocketException)
            {
                if (serverResponse != null)
                {
                    serverResponse("Client Disconnected... " + ((Socket)ar.AsyncState).LocalEndPoint.ToString());
                }
                _clientSocket.Remove((Socket)ar.AsyncState);
            }
        }
